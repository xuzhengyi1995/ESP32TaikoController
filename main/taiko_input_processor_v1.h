...
#ifndef MAIN_TAIKO_INPUT_PROCESSOR_V1_
#define MAIN_TAIKO_INPUT_PROCESSOR_V1_
...
class TaikoInputProcessorV1 : public TaikoInputProcessor {
public:
  TaikoInputProcessorV1(AdcController *adc_controller,
...
private:
  ...
  static int max_index_[kPlayerCount];
  static int max_power_[kPlayerCount];
...
#endif // MAIN_TAIKO_INPUT_PROCESSOR_V1_